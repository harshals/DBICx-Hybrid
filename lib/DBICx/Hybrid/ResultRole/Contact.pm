package DBICx::Hybrid::ResultRole::Contact;
...
sub set_up {
	...
	$self->add_columns(
		...
		"title", { data_type => "VARCHAR(200)", is_nullable => 1 },
		"company_id", { data_type => "VARCHAR(200)", is_nullable => 1 },
		...
		"contact_type", { data_type => "VARCHAR(200)", is_nullable => 1 }
